...
DEFAULT_ENERGY = 12650. #13179.2 #15355.6 #15306. #15348.5 #15370.0 #13215.0
...
class energy(object):
    ...
    def get_energy(self):
        if self.tunable:
            energy = self.mono.read_attribute('energy').value * 1.e3
        else:
    ...
    def turn_on(self):
        if self.test or not self.tunable : return
