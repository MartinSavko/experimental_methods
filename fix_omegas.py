...
def main(master_filename):
    ...
    if delta < 0:
       print("delta %.3f is negative"% delta, m['entry/sample/goniometer/omega_range_average'][()])
       ...
       m['entry/sample/goniometer/omega_range_average'].write_direct(np.array([-delta]))
    else:
       print("delta %.3f okay, moving on" % delta,  m['entry/sample/goniometer/omega_range_average'][()])
...
if __name__ == '__main__':
   ...
   parser.add_argument('-m', '--master', type=str, default='./Lille_MannitouFab_01032023__G8-2_rscan_2024-04-10_10-10-30_master.h5', help='master file to fix')
