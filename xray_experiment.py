...
from motor import undulator, monochromator_rx_motor, undulator_mockup, monochromator_rx_motor_mockup
...
from monitor import xbpm, xbpm_mockup, eiger_en_out, fast_shutter_close, fast_shutter_open, trigger_eiger_on, trigger_eiger_off, Si_PIN_diode, sai, monitor, jaull, tdl_xbpm
...
class xray_experiment(experiment):
    ...
    specific_parameter_fields = [{'name': 'photon_energy', 'type': 'float', 'description': 'photon energy of the experiment in eV'},
                                 ...
                                 {'name': 'undulator_gap_encoder_position', 'type': 'float', 'description': 'experiment undulator gap encoder reading in mm'},
                                 {'name': 'monitor_sleep_time', 'type': 'float', 'description': 'default pause between monitor measurements in s'},
                                 {'name': 'beware_of_top_up', 'type': 'bool', 'description': 'try to avoid top-up'},
                                 {'name': 'tdl_xbpm1_position', 'type': 'dict', 'description': 'electron beam position at tdl xbpm1'},
                                 {'name': 'tdl_xbpm2_position', 'type': 'dict', 'description': 'electron beam position at tdl xbpm2'},
                                 {'name': 'vfm_position', 'type': 'dict', 'description': 'vertical focusing mirror position'},
                                 {'name': 'hfm_position', 'type': 'dict', 'description': 'horizontal focusing mirror position'},
                                 {'name': 'experimental_table_position', 'type': 'dict', 'description': 'experimental table position'},
                                 {'name': 'mono_mt_rx_position', 'type': 'dict', 'description': 'mono rx position'},
                                 {'name': 'mono_mt_rx_fine_position', 'type': 'dict', 'description': 'mono rx_fine position'},
    ...
    def __init__(self,
        ...
        # Necessary equipment
        self.actuators = [{'name': 'goniometer', 'object': goniometer, 'must': True},
                          {'name': 'frontend_shutter', 'object': frontend_shutter, 'must': True},
                          {'name': 'safety_shutter', 'object': safety_shutter, 'must': True},
                          {'name': 'fast_shutter', 'object': fast_shutter, 'must': True, 'kwargs': {'panda': panda}},
                          {'name': 'beam_center', 'object': beam_center, 'mockup': beam_center_mockup},
                          {'name': 'detector', 'object': detector, 'must': True},
                          {'name': 'resolution_motor', 'object': resolution_motor, 'mockup': resolution_mockup},
                          {'name': 'energy_motor', 'object': energy_motor, 'mockup': energy_mockup},
                          {'name': 'flux_monitor', 'object': flux_monitor, 'mockup': flux_mockup},
                          {'name': 'transmission_motor', 'object': transmission_motor, 'mockup': transmission_mockup},
                          {'name': 'machine_status', 'object': machine_status, 'mockup': machine_status_mockup},
                          {'name': 'undulator', 'object': undulator, 'mockup': undulator_mockup},
                          {'name': 'monochromator_rx_motor', 'object': monochromator_rx_motor, 'mockup': monochromator_rx_motor_mockup},
                          ...
                          {'name': 'experimental_table_actuator', 
                           'object': experimental_table,
                           'kwargs': {'attributes': ['pitch', 'roll', 'yaw', 'zC', 'xC', 't1z', 't2z', 't3z', 't4x', 't5x']},
                           'mockup': monitor}]

        for name, device_name in [('vfm_pitch_actuator', 'i11-ma-c05/op/mir.2-mt_rx'), 
                                  ('hfm_pitch_actuator', 'i11-ma-c05/op/mir.3-mt_rz'),
                                  ('vfm_trans_actuator', 'i11-ma-c05/op/mir.2-mt_tz'),
                                  ('hfm_trans_actuator', 'i11-ma-c05/op/mir.3-mt_tx'),
                                  ('mono_mt_rx_actuator', 'i11-ma-c03/op/mono1-mt_rx'),
                                  ('mono_mt_rx_fine_actuator', 'i11-ma-c03/op/mono1-mt_rx_fine')]:
            a = {'name': name, 'object': tango_motor, 'kwargs': {'device_name': device_name}}
        ...
        self.observers = [{'name': 'xbpm1', 
                          ...
                          {'name': 'sai1', 
                           'object': sai, 
                           'kwargs': {'device_name': 'i11-ma-c00/ca/sai.1', 
                                      'continuous_monitor_name': 'sai1_monitor'}, 
                           'mockup': monitor},
                          {'name': 'sai2', 
                           'object': sai, 
                           'kwargs': {'device_name': 'i11-ma-c00/ca/sai.2',
                          ...
                          {'name': 'sai3', 
                           'object': sai, 
                           'kwargs': {'device_name': 'i11-ma-c00/ca/sai.3', 
                                      'continuous_monitor_name': 'sai3_monitor'}, 
                           'mockup': monitor},
                          {'name': 'sai4', 
                           'object': sai, 
                           'kwargs': {'device_name': 'i11-ma-c00/ca/sai.4', 
                                      'continuous_monitor_name': 'sai4_monitor'}, 
                           'mockup': monitor},
                          {'name': 'sai5', 
                           'object': sai, 
                           'kwargs': {'device_name': 'i11-ma-c00/ca/sai.5', 
                                      'continuous_monitor_name': 'sai5_monitor'}, 
                           'mockup': monitor},
                          {'name': 'jaull05', 
                           'object': jaull, 
                           'kwargs': {'device_name': 'i11-ma-c05/vi/jaull.1', 
                                      'name': 'jaull05'}, 
                           'mockup': monitor},
                          {'name': 'jaull06', 
                           'object': jaull, 
                           'kwargs': {'device_name': 'i11-ma-c06/vi/jaull.1', 
                                      'name': 'jaull06'}, 
                           'mockup': monitor},
                          {'name': 'eiger_en_out', 'object': eiger_en_out, 'mockup': monitor},
                          {'name': 'trigger_eiger_on', 'object': trigger_eiger_on, 'mockup': monitor}, 
                          {'name': 'trigger_eiger_off', 'object': trigger_eiger_off, 'mockup': monitor},
                          {'name': 'fast_shutter_open', 'object': fast_shutter_open, 'mockup': monitor}, 
                          {'name': 'fast_shutter_close', 'object': fast_shutter_close, 'mockup': monitor}, 
        ...
        for name, device_name in [('vfm_pitch', 'i11-ma-c05/op/mir.2-mt_rx'), 
            ...
            o = {'name': name, 'object': tango_motor, 'kwargs': {'device_name': device_name}}
    ...
    def check_top_up(self, equilibrium=3, sleeptime=1.):
        ...
        time_to_next_top_up = self.machine_status.get_time_to_next_top_up(trigger_current=trigger_current)
        while (self.scan_exposure_time <= top_up_period/4.) and (time_to_next_top_up <= self.scan_exposure_time * 1.05) and time_to_next_top_up > 0:
            logging.info('expected time to next the top up %.1f seconds, waiting for it ...' % time_to_next_top_up)
            gevent.sleep(max(sleeptime, time_to_next_top_up/2.))
            time_to_next_top_up = self.machine_status.get_time_to_next_top_up(trigger_current=trigger_current)
        
        time_from_last_top_up = self.machine_status.get_time_from_last_top_up()
        while time_from_last_top_up < equilibrium:
            logging.info('waiting for things to settle after the last top up (%.1f seconds ago)' % time_from_last_top_up)
            gevent.sleep(max(sleeptime, time_from_last_top_up/2))
            time_from_last_top_up = self.machine_status.get_time_from_last_top_up()
            
        logging.info('time to next top up %.1f seconds, expected scan duration is %.1f seconds, executing the scan ...' % (time_to_next_top_up, self.scan_exposure_time ))
    ...
    def get_vfm_position(self):
        pitch = self.vfm_pitch_actuator.get_position()
        trans = self.vfm_trans_actuator.get_position()
        return {'pitch': pitch, 'translation': trans}
    
    def get_hfm_position(self):
        pitch = self.hfm_pitch_actuator.get_position()
        trans = self.hfm_trans_actuator.get_position()
        return {'pitch': pitch, 'translation': trans}
    
    def get_experimental_table_position(self):
        return self.experimental_table_actuator.get_position()

    def get_mono_mt_rx_position(self):
        return self.mono_mt_rx_actuator.get_position()

    def get_mono_mt_rx_fine_position(self):
        return self.mono_mt_rx_fine_actuator.get_position()
        ...
        for k in [1, 2, 3, 5, 6]:
            ...
            for direction in ['vertical', 'horizontal']:
                for attribute in ['gap', 'position']:
                    conf['%s_%s' % (direction, attribute)] =  getattr(getattr(self, 'slits%d' % k), 'get_%s_%s' % (direction, attribute))()
    ...
    def start_monitor(self):
        ...
        if hasattr(self, 'actuator'):
            ...
            if hasattr(self, 'actuator_names'):
                self.observers_threads = [gevent.spawn(self.actuator.monitor, self.start_time, self.actuator_names)]
            else:
                self.observers_threads = [gevent.spawn(self.actuator.monitor, self.start_time)]
        else:
            self.observers_threads = []
        for monitor in self.monitors:
            monitor.observe = True
            self.observers_threads.append(gevent.spawn(monitor.monitor, self.start_time))
    ...
    def set_transmission(self, transmission=None, wait=True, tolerance=0.1, sleeptime=0.05):
        if transmission is not None:
            self.transmission = transmission
            self.transmission_motor.set_transmission(transmission)
            while abs(self.transmission_motor.get_transmission() - transmission) >= tolerance:
    ...
    def get_results(self):
        ...
        if hasattr(self, 'actuator'):
            results['actuator_monitor'] = {'observation_fields': self.actuator.get_observation_fields(),
        ...
        for (monitor_name, monitor) in zip(self.monitor_names, self.monitors):
            ...
            _m_start = time.time()
            try:
                if hasattr(monitor, 'continuous_monitor_name') and monitor.continuous_monitor_name != None:
                    results[monitor_name] = {'observation_fields': monitor.get_observation_fields(),
                                            'observations': monitor.get_observations_from_history(start=self.start_time)}
                else:
                    results[monitor_name] = {'observation_fields': monitor.get_observation_fields(),
                                            'observations': monitor.get_observations()}
            except:
                message = 'Could not get diagnostic information from %s, please check' % monitor_name
                print(message)
                self.logger.info(message)
                exc = traceback.format_exc()
                print(exc)
                self.logger.debug(exc)
            self.logger.debug('results from %s took %.4f seconds' % (monitor_name, time.time() - _m_start))
