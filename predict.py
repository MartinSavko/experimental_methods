...
def get_most_likely_click(predictions, min_size=32):
    ...
    for notion in ['crystal', 'loop']:
        notion_prediction = get_notion_prediction(predictions, notion, min_size=min_size)
...
if __name__ == '__main__':
    ...
    parser.add_argument('-t', '--to_predict', type=str, default='learning_dataset/100161_Sat_Jun__1_15:43:20_2019', help='to_predict')
    ...
    parser.add_argument('-m', '--min_size', default=32, type=int, help='minimum object size')
