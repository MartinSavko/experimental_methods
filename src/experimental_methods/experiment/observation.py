...
class observation(object):
    def __init__(self, monitors, duration=None, observe=True, plotsleeptime=0.1):
    ...
    def run(self):
        ...
        observers = [
            gevent.spawn(monitor.monitor, self._start) for monitor in self.monitors
        ]
...
def main():
    ...
    parser.add_option(
        ...
        default=5,
        type=float,
        help="Specify how long to observe (default=%default). If not specified observe without a limit.",
    )
