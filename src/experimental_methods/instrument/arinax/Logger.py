...
rfh = RotatingFileHandler('log/{:%Y-%m-%d %H%M%S}.log'.format(datetime.now()), 'a', 1000000, 1)
...
rfh1 = RotatingFileHandler('log/{:%Y-%m-%d %H%M%S}-Error.log'.format(datetime.now()), 'a', 1000000, 1)
