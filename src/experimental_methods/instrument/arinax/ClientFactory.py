"""
  ...
  ARINAX Sep. 2021
"""
from ExporterClientArinax import ExporterClientFactory
...
class ClientFactory:
    ...
    global impl
    impl = {'tango': getTangoInstantiator, 'exporter': ExporterClientFactory.instantiate, 'epics': getEpicsInstantiator}
