...
l1_jump =  0.116000E+01


#/* L2-edge jump (Z>27) */

l2_jump =  0.141000E+01
...
def mcmaster(ephot, *fit_coefficients):
    log_e = ephot==1. and ephot or np.log(ephot)
...
def mucal(name, ephot, unit='a'):
    ...
    energy = [k_edge[Z], l1_edge[Z], l2_edge[Z], l3_edge[Z], m_edge[Z], k_alpha1[Z], k_beta1[Z], l_alpha1[Z], l_beta1[Z]]
    ...
    if ((abs( k_edge[Z] - ephot) <= 0.001) or  #  /* data within K edge */
        (abs(l1_edge[Z] - ephot) <= 0.001) or  #  /* data within L1 edge */
