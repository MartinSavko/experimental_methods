...
class detector(eiger):
    ...
    def insert_protective_cover(self, safe_distance=120.0, delta=1.0, timeout=3.0, wait=True):
    ...
    def extract_protective_cover(self, safe_distance=120.0, delta=1.0, timeout=3.0, wait=True):
