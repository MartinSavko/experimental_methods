...
class transmission:
    ...
    def __init__(self, mode='horizontal', 
                 slits1_reference_scan='/usr/local/bin/mxcube_local/HardwareRepository/HardwareObjects/SOLEIL/PX2/experimental_methods/s1d_results.pickle',
                 slits2_reference_scan='/usr/local/bin/mxcube_local/HardwareRepository/HardwareObjects/SOLEIL/PX2/experimental_methods/s2d_results.pickle', 
                 reference_gap=4., 
