...
class axis_camera:
    ...
    def get_header(self):
        ...
        while True:
            ...
            try:
                ...
                self.header[
                    "Content-Length"
                ] = 0  # set content_length to zero if there is a problem reading header
    ...
    def save_image(self, image_name=None):
        ...
        if image_name is None:
            pan, tilt, zoom = position["pan"], position["tilt"], position["zoom"]
            image_name = "/927bis/ccd/Snapshots/%s_%s_%s_%s.jpg" % (
                self.host,
                pan,
                tilt,
                zoom,
...
if __name__ == "__main__":
    ...
    cam6_samp_env = {
        "pan": -63.890599999999999,
        "tilt": 3.2000000000000002,
        "zoom": 5447.0,
    }
    # cam8 detector
    cam8_detector = {
        "pan": -28.195799999999998,
        "tilt": -55.424999999999997,
        "zoom": 900.0,
    }
