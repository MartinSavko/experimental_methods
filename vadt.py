...
def main():
    ...
    parser.add_argument('-r', '--raster', default='/nfs/data4/2024_Run3/com-proxima2a/Commissioning/automated_operation/px2-0042/puck_09_pos_12_g/tomo/tomo_a_puck_09_pos_12_g_parameters.pickle', type=str, help='raster')
    parser.add_argument('-v', '--volume', default='/nfs/data4/2024_Run3/com-proxima2a/Commissioning/automated_operation/px2-0042/puck_09_pos_12_g/opti/oa_puck_09_pos_12_g_zoom_X_careful_parameters.pickle', type=str, help='optical')
    ...
    vadt = volume_aware_diffraction_tomography(directory=r['directory'], name_pattern=r['name_pattern'], volume=oa.get_pcd_mm_name())
