...
class mirror_scan(slit_scan):
    ...
    specific_parameter_fields = [{'name': 'mirror', 'type': 'str', 'description': 'Target mirror'},
    ...
    def __init__(self,
        ...
        self.description = 'Slits %d mirror scan scan between %6.1f and %6.1f mm, Proxima 2A, SOLEIL, %s' % (slits, start_position, end_position, time.ctime(self.timestamp))
