...
def show_shapes(directory):
    ...
    opti = glob.glob(os.path.join(directory, "opti", "oa_*_careful_mm.pcd"))[-1]
    optio = glob.glob(os.path.join(directory, "opti", "oa_*_X_careful_mm.obj"))[-1]
    try:
        tomo = glob.glob(os.path.join(directory, "tomo", "opt_*_tioga.pcd"))[0]
    except:
        tomo = None
...
if __name__ == "__main__":
    ...
    parser.add_argument("-d", "--directory", default="/nfs/data4/2025_Run2/20250023/2025-04-20/RAW_DATA/PTPN22/PTPN22-CD044623_H04-1_BX033A-12", type=str, help="directory")
