...
def main():
    ...
    parser.add_argument('-d', '--directory', default='/nfs/ruche/proxima2a-soleil/com-proxima2a/flyscan/2023_Run3/plate/2023-06-06', type=str, help='directory')
    parser.add_argument('-f', '--filename', default='flyscan_3977.nxs', type=str, help='filename')
    ...
    es = energy_scan(name_pattern=args.filename, directory=args.directory, element=args.element, edge=args.edge)
    ...
    normalized_counts = 1000. * roi_counts/compton_counts
